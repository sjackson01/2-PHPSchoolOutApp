...
if (!$firstName || !$lastName)//Check correct variables are entered
    { 
        echo 'Please enter a student name.';
    }
    elseif ($currentGrade < 9 || $currentGrade > 12)//Check for highschool student
    {
        echo 'This is only for highschool student. Please enter a grade between 9 and 12.';
    }
    else
    {
        if($finalAverage < .70)
